  ...
  return (
    ...
    >
      <div className="bg-white rounded-[2rem] border border-slate-200 shadow-xl p-8 md:p-12 relative overflow-hidden">
        {/* Subtle inner glow */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[80%] h-[1px] bg-gradient-to-r from-transparent via-emerald-200 to-transparent" />
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[200px] h-[100px] bg-emerald-50 blur-[50px] pointer-events-none" />

        <div className="relative z-10 text-center mb-10">
          <h1 className="text-3xl font-medium tracking-tight text-slate-900 mb-2">Create an account</h1>
          ...
          <div className="space-y-1">
            <div className="relative flex items-center">
              ...
              <input 
                ...
                {...register("name")}
                className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3.5 pl-11 pr-4 text-sm text-slate-900 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all font-light placeholder:text-slate-400"
              />
            </div>
            {errors.name && (
        ...
        <div className="mt-8 text-center relative z-10">
          <p className="text-sm text-slate-500 font-light">
            ...
            <Link href="/login" className="text-slate-900 hover:text-emerald-600 font-medium transition-colors">
              Sign In
            </Link>
          </p>
        </div>
