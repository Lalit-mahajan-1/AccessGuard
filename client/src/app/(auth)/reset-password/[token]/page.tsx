  ...
  return (
    ...
    >
      <div className="bg-[#0a0a0a] rounded-[2rem] border border-white/5 shadow-2xl p-8 md:p-12 relative overflow-hidden">
        {/* Subtle inner glow */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[80%] h-[1px] bg-gradient-to-r from-transparent via-purple-500/50 to-transparent" />
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[200px] h-[100px] bg-purple-500/10 blur-[50px] pointer-events-none" />

        {isSuccess ? (
          <div className="relative z-10 text-center flex flex-col items-center">
            <div className="w-16 h-16 bg-purple-500/10 rounded-full flex items-center justify-center mb-6">
              <CheckCircle2 size={32} className="text-purple-400" strokeWidth={1.5} />
            </div>
            <h1 className="text-2xl font-medium tracking-tight text-white mb-2">Password Reset</h1>
          ...
          <>
            <div className="relative z-10 text-center mb-10">
              <h1 className="text-3xl font-medium tracking-tight text-white mb-2">New Password</h1>
              ...
              <div className="space-y-1">
                <div className="relative flex items-center">
                  ...
                  <input 
                    ...
                    {...register("password")}
                    className="w-full bg-[#111] border border-white/10 rounded-xl py-3.5 pl-11 pr-4 text-sm text-white focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all font-light placeholder:text-white/20"
                  />
                </div>
                {errors.password && (
